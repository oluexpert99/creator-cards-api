...
const ERROR_CODE = {
  ...
  // Creator Card business-rule codes — value === the literal wire `code` so that
  // `error.errorCode` is emitted verbatim as the response `code`.
  SL02: 'SL02',
  AC01: 'AC01',
  AC05: 'AC05',
  NF01: 'NF01',
...
const ERROR_STATUS_CODE_MAPPING = {
  ...
  // Creator Card business-rule codes (keyed by the literal code value).
  SL02: 400,
  AC01: 400,
  AC05: 400,
  NF01: 404,
